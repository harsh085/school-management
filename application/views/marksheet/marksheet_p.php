...
<!-- <div class="container"> -->
    ...
    <center>
        ...
        <div style="font-size: 30px;font-weight:bold;">
            MAA SHARDA VIDYA MANDIR<br>HIGH SCHOOL
        </div>
        <span style="border: 1px groove black;padding: 2px;font-size: 18px;" >ENGLISH MEDIUM</span>
        <div style="font-size:20px;"> PRAKASH NAGAR, DHAR (MP)</div>
  ...
  <center>
        ...
        <?php $sess = (int)$sess; ?>
        <span style="font-size: 15px;"><b>ACADEMIC SESSION 20<?php echo $sess-1; ?>-<?php echo $sess; ?></b></span>
...
<!-- </div> -->
<footer class="footer">*This document is <b><i><u>not valid</u>  without Signature and Stamp.</i></b></footer>
</body>
</html>

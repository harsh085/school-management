...
<form action="<?php echo base_url('marksheet/save_details') ?>" method="POST"  >
          ...
          <fieldset>
             ...
             <div class="form-group">
              ...
              <select class="form-control" name="clas" id="clas" style="width:100px;" >
                ...
                <?php foreach ($classData as $key => $value) { 
                     if($value['class_id']==6 || $value['class_id']==7 || $value['class_id']==8 || $value['class_id']==9){
                  ?>
            ...
            <!-- Hidden field for class 6, 7, 8, 9 -->
                <input type="number" name="temp" value=0 required hidden>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="science">Science</label>
                <input type="number" max="120" min="0" class="form-control" id="science" name="science" value="<?php echo set_value('science'); ?>" placeholder="Marks in Science" required>
                <?php echo form_error('science'); ?>
            </div>
            <div class="form-group">
              <label for="sans">Sanskrit</label>
                <input type="number" max="120" min="0" class="form-control" id="sans" name="sans" value="<?php echo set_value('sans'); ?>" placeholder="Marks in Sanskrit" required>
                <?php echo form_error('sans'); ?>
            </div>
            <div class="form-group">
              <label for="sst">SST</label>
                <input type="number" max="120" min="0" class="form-control" id="sst" name="sst" value="<?php echo set_value('sst'); ?>" placeholder="Marks in SST" required>

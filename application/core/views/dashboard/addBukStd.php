			...
			<div class="panel panel-default">	
				...
				<div class="col-md-2 col-sm-12">
					<div class="form-group">
                		...
                		<input type="date" class="form-control form-control-sm" id="dob<?php echo $i; ?>" value="<?php echo set_value('<?php echo $i; ?>dob'); ?>" min="2000-01-01" max="2019-01-01" placeholder="Date of Birth" required >
            		</div>
				</div>
				<div class="col-md-2 col-sm-12">
					<div class="form-group">
...
$(document).ready(function() {
	...
	$('#submit').on('click', function() {
		...
		if(nm.length && rl.length && ph.length && cls.length && db.length){
			$.ajax({

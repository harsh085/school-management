...
<form action="<?php echo base_url('dashboard/add_std') ?>" method="POST"  >
          <div class="row">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="fullname" name="fullname" value="<?php echo set_value('fullname'); ?>" placeholder="First Name" required >
            ...
            <div class="form-group">
              <label for="dob">Date of Birth</label>
                <input type="date" class="form-control" id="dob" name="dob" value="<?php echo set_value('dob'); ?>"  placeholder="Date of Birth" required>
 		...
 		<div class="col-md-4 col-sm-12">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="address" name="address" value="<?php echo set_value('address'); ?>" placeholder="Address" autocomplete="off" required>
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="regDate" name="registerDate" value="<?php echo set_value('registerDate'); ?>" placeholder="Register Date" autocomplete="off">
            </div>
            <div class="form-group">
              ...
              <select class="form-control" name="clas" id="clas" style="width:100px;" >
                ...
                <?php foreach ($classData as $key => $value) { ?>
                  <option value="<?php echo $value['class_id'] ?>" <?php echo set_select('clas', $value['class_id'], False); ?> ><?php echo $value['class_id'] ?></option>
                <?php } // /forwach ?>
              </select>
